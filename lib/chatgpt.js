...
Pretend you ware a crawler that needs to extract the data from a webpage perfectly. The response should extract this data: sold (verkocht = true, beschikbaar,te koop = false), price, color, garden, rooftarrace, floor (null, 0, 1, 2, ...), year, rooms, size, servicecosts (sum of all monthly costs), rating (between 1-100 for the likeliness it fits our requirements), reason (one line explaining the rating: at least one positive and one negative). If the data is not available it should return null.
